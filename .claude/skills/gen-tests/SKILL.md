---
name: gen-tests
description: Generate pytest tests for a FastAPI endpoint in this repo. Use when asked to write tests, add test coverage, create a test file, test an endpoint, write pytest for a route, or cover an API endpoint with tests.
---
...
Invoke with a target: `/gen-tests for the /api/orders endpoint` or let Claude trigger it from natural language when you ask to write tests, add coverage, or create a test file for an endpoint.
