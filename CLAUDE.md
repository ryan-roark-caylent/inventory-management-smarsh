...
- This lab runs inside its own isolated `lab-3-work` worktree so work can't collide across labs and you keep everything at the end. It was created in Step 0 of the participant guide (`git worktree add -b lab-3-work ../lab-3-work lab-3-start`).
- **If you are in the main clone instead of a worktree, do NOT `git switch`** — create/enter the worktree first: `git worktree add -b lab-3-work ../lab-3-work lab-3-start`, then `cd ../lab-3-work` and relaunch Claude Code there.
